...
var _modalBoxCss = _interopRequireDefault(require("../../@patternfly/patternfly-next/components/ModalBox/modal-box.css.js"));
...
var ModalBox = function ModalBox(_ref) {
  var children = _ref.children,
      ...
      title = _ref.title,
      id = _ref.id,
      props = _objectWithoutProperties(_ref, ["children", "className", "isLarge", "title", "id"]);
  ...
  return _react.default.createElement("div", _extends({}, props, {
    ...
    "aria-describedby": id,
    "aria-modal": "true",
    className: (0, _reactStyles.css)(_modalBoxCss.default.modalBox, className, isLarge && _modalBoxCss.default.modifiers.lg)
  }), children);
};
