...
var _levelCss = _interopRequireDefault(require("../../@patternfly/patternfly-next/layouts/Level/level.css.js"));
...
var Level = function Level(_ref) {
  ...
  return _react.default.createElement("div", _extends({}, props, {
    className: (0, _reactStyles.css)(_levelCss.default.level, gutter && (0, _gutters.getGutterModifier)(_levelCss.default, gutter, _levelCss.default.modifiers.gutter), className)
  }), children);
};
