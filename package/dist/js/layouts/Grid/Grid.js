...
var _gridCss = _interopRequireDefault(require("../../@patternfly/patternfly-next/layouts/Grid/grid.css.js"));
...
var Grid = function Grid(_ref) {
  ...
  return _react.default.createElement("div", _extends({
    className: _reactStyles.css.apply(void 0, classes.concat([gutter && (0, _gutters.getGutterModifier)(_gridCss.default, gutter, _gridCss.default.modifiers.gutter), className]))
  }, props), children);
};
