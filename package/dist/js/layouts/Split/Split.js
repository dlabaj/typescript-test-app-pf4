...
var _splitCss = _interopRequireDefault(require("../../@patternfly/patternfly-next/layouts/Split/split.css.js"));
...
var Split = function Split(_ref) {
  ...
  return _react.default.createElement(Component, _extends({}, props, {
    className: (0, _reactStyles.css)(_splitCss.default.split, gutter && (0, _gutters.getGutterModifier)(_splitCss.default, gutter, _splitCss.default.modifiers.gutter), className)
  }), children);
};
