...
import styles from "../../@patternfly/patternfly-next/components/Backdrop/backdrop.css.js";
var propTypes = {
...
function (_React$Component) {
  ...
  function Modal() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "id", "pf-modal-".concat(currentId++));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "toggleSiblingsFromScreenReaders", function (hide) {
