...
import styles from "../../@patternfly/patternfly-next/components/Button/button.css.js";
...
var Button = function Button(_ref) {
  ...
  return React.createElement(Component, _extends({}, props, {
    ...
    className: css(styles.button, getModifier(styles.modifiers, variant), isBlock && styles.modifiers.block, isDisabled && styles.modifiers.disabled, isActive && styles.modifiers.active, isFocus && styles.modifiers.focus, isHover && styles.modifiers.hover, className),
